        ...
        <div className="p-6">
          <DialogHeader className="space-y-4">
            <div className="space-y-2">
              <DialogTitle className="text-xl font-semibold tracking-tight">Delete this category?</DialogTitle>

              <DialogDescription className="text-sm leading-6 text-muted-foreground">
                You&apos;re about to permanently delete this category. This action cannot be undone, and all associated
                data will be lost.
              </DialogDescription>
            </div>
          </DialogHeader>
          ...
          <div className="mt-6 rounded-lg border border-destructive/20 bg-destructive/5 px-4 py-3">
            ...
            <p className="mt-1 text-xs leading-5 text-muted-foreground">
              Please make sure you want to continue before deleting this category.
            </p>
          </div>
        </div>
